...
void eres_twrcut()
{
  ...
  /*  auto prof1 = new TProfile("prof1","CEMC ",NBINS,edges,-2.6,2.6);
  auto prof2 = new TProfile("prof2","FEMC ",NBINS,edges,-2.6,2.6);
  auto prof3 = new TProfile("prof3","EEMC ",NBINS,edges,-2.6,2.6);
  */
	  ...
	  //  if(te1 > ecut)
	    {
	      ...
	      //   te1 = te1/(0.845006 + 0.0172143*ge1 - 0.000868737*ge1*ge1 + 0.000014512*ge1*ge1*ge1);
	  ...
	  //	  if(te2 > ecut)
	    {
	      ...
	      //     te2 = te2/(0.688478 + 0.0202863*ge2 - 0.00115522*ge2*ge2 + 0.0000206469*ge2*ge2*ge2);
	  ...
	  //	  if(te3 > ecut)
	    {
	      ...
	      //  te3 = te3/(0.73728 + 0.0258359*ge3 - 0.00142287*ge3*ge3 + 0.0000252328*ge3*ge3*ge3);
  ...
  for(int i=0; i<NBINS; i++)
    {
      ...
      TF1 *Fgauss2=new TF1(name,"gaus",-0.5,0.5);
      /*   if(j==1)
  ...
  for(int i=0; i<NBINS; i++)
    {
      ...
      // TF1 *Fgauss3=new TF1(name,"gaus",-0.2,0.2);
      ...
      if(j==10)
	Fgauss3->SetRange(-0.1, 0.05); //for cali
      if(j==9)
	Fgauss3->SetRange(-0.1, 0.05); //for cali
